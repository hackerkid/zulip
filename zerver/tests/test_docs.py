...
class PlansPageTest(ZulipTestCase):
    ...
    def test_CTA_text_by_plan_type(self) -> None:
        ...
        with self.settings(FREE_TRIAL_DAYS=60):
            ...
            self.assert_not_in_success_response([sign_up_now, sponsorship_pending, buy_standard], result)
        ...
        plan = CustomerPlan.objects.create(customer=customer, tier=CustomerPlan.STANDARD,
